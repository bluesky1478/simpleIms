...
<form name="frmOrder" method="post" class="frm-order" id="documentApp" @submit.stop.prevent="onSubmit(items)"  >
    ...
    <div class="row">
            ...
            <div class="col-xs-12">
                <div class="table-title ">
                    ...
                    <div class="flo-right form-inline" >
                        ...
                        <input type="file" style="font-size:13px; font-weight:normal; display: inline-block" @change="setUploadFile('partInfo',event)">
                        <div class="btn btn-sm btn-red" style="display: inline-block" @click="getUploadData('partInfo', items, index)">업로드</div>
                    </div>
                </div>
            ...
            <div class="col-xs-12">
                <div class="table-title ">
                    ...
                    <div class="flo-right form-inline" >
                        ...
                        <input type="file" style="font-size:13px; font-weight:normal; display: inline-block" @change="setUploadFile('subPartInfo',event)">
                        <div class="btn btn-sm btn-red" style="display: inline-block" @click="getUploadData('subPartInfo', items, index)">업로드</div>
                    </div>
                </div>
                <div>
                    <table class="table table-cols center-header center-contents sample-spec-table">
                ...
                <div>
                    <table class="table table-cols center-header center-contents sample-spec-table">
                        ...
                        <tr>
                            <th>기타사항</th>
                            <td  style="padding:5px !important; text-align:left">
                                <textarea class="form-control" rows="6" v-model="item.etcMemo"></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="col-xs-12" style="border-top:solid 1px #d1d1d1; width:100%">&nbsp;</div>
...
<script type="text/javascript">
    ...
    let externVueMethod = {
        ...
        onSubmit : function (items) {
            ...
            upFileArray = sampleDropzone.getFileList().concat(etcDropzone.getFileList());
        ...
        for(let key in el.items.docData.sampleData){
            if(  typeof sampleDropzone.fileList[key] == 'undefined' ){
                ...
                let etcDropzoneSetParams = {
                    ...
                    fieldName2 : 'fileEtc',
                    success : function(file, response){
                        completeProc(etcDropzone, file, response);
                    }
                };
