<table class="table table-cols table-default-center" style="border-top:none">
    ...
    <tbody class="text-center" v-if="0 >= customerEstimateList.length" v-show="showStyle">
    <tr>
        <td colspan="99">견적 내역이 없습니다.</td>
    </tr>
    </tbody>
    ...
    <tr>
        ...
        <!--<td >총수량
            <div>{% $.setNumberFormat(custEstimate.qty) %}</div>
        </td>-->
        <td ><!--공급가-->
        ...
        <td ><!--수신-->
            <ul>
                <li v-for="receiver in custEstimate.receiverInfo">
                    ...
                    <span class="font-10 text-muted">({% receiver.mail %})</span>
                </li>
            </ul>
        </td>
    </tr>
