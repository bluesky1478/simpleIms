...
<ul class="nav nav-tabs mgb0" role="tablist">
    <li role="presentation" <?=$isShow == 'y' && $listType == 'board' ? 'class="active"' : ''?>>
        <a href="../recap/article_list.php?isShow=y&bdId=<?=$req['bdId']?>&listType=board">일반 게시물</a>
    </li>
    <li role="presentation" <?=$isShow == 'n' && $listType == 'board' ? 'class="active"' : ''?>>
        <a href="../recap/article_list.php?isShow=n&bdId=<?=$req['bdId']?>&listType=board">신고 게시물</a>
    </li>
    <li role="presentation" <?=$isShow == 'n' && $listType == 'memo' ? 'class="active"' : ''?>>
        <a href="../recap/article_list.php?isShow=n&bdId=<?=$req['bdId']?>&listType=memo">신고 댓글</a>
    </li>
</ul>
<?php } ?>
