...
<section id="imsApp">
    ...
    <div class="" v-show="product.sno > 0">
        ...
        -->
        <section v-show="2 === sampleTabMode"><?php include 'template/ims_product_sample.php'?></section>
        ...
        <section v-show="6 === sampleTabMode"><?php include 'template/ims_product_cost_compare.php'?></section>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <section >
                        ...
                        <!--확정견적 폼-->
                        <div class="" v-show="'cost' === estimateView.estimateType">
                        ...
                        <!--가견적 폼-->
                        <div class="" v-show="'estimate' === estimateView.estimateType">
                            <table class="table table-cols table-pd-5 table-td-height0 table-th-height0" style="margin-bottom:0 !important;">
                                <colgroup>
                                    <col class="w-10p">
                                    <col class="width-xl">
                                    <col class="w-10p">
                                ...
                                <tbody >
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline font-14" style="padding:0">
                                                <input type="radio" name="optionAddType2"  value="estimate"  v-model="estimateView.estimateType" />가견적
                                            </label>
                                            <label class="radio-inline font-14" style="padding:0">
                                                <input type="radio" name="optionAddType2"  value="cost" v-model="estimateView.estimateType" />생산확정견적
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <th>의뢰처</th>
                                        <td>
                                            <select2 class="js-example-basic-single" style="width:100%" v-model="estimateView.reqFactory" id="selCostFactory">
                                                <option value="0">선택</option>
                                                <?php foreach ($produceCompanyList as $key => $value ) { ?>
                                                    <option value="<?=$key?>"><?=$value?></option>
                                                <?php } ?>
                        ...
                        <div class="dp-flex dp-flex-gap10 mgb20 border-bottom-light-gray-imp pdb10">
                            <div class="pdt5 pdl5 table-title gd-help-manual">
                                # 참고파일
                            </div>
                            <div class="clear-both dp-flex">
                            ...
                            <div class="pdt5 pdl5 table-title gd-help-manual mgl30">
                                # 기존 견적 불러오기
                            </div>
                            
                            <div class="mgt20 dp-flex ">
