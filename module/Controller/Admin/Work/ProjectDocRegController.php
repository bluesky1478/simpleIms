...
class ProjectDocRegController extends \Controller\Admin\Controller{
    public function index(){

        $this->addScript([
            '../../script/vue.js',
            '../../script/dropzone/min/dropzone.min.js',
            '../../script/vue-datetime/luxon.min.js',
            /*'../../script/vue-datetime/vue-datetime.common.js',
            '../../script/vue-datetime/vue-datetime.js',*/
        ]);
        $this->addCss(
            [
                '../../script/dropzone/min/dropzone.min.css',
                /*'../../script/vue-datetime/vue-datetime.css',*/
            ]
        );
