 ...
 * @author  yjwee
 */
class ScmMemberPsController extends \Controller\Admin\Controller
{
    /**
     * @inheritdoc
     */
        ...
        try {
            ...
            switch ($requestAllParams['mode']) {
                case 'order_wait':
                    ...
                    $this->json(__($orderService->orderWait($requestPostParams)));
                    break;
                case 'order_accept':
                    $orderService = SlLoader::cLoad('Order','OrderService');
                    $this->json($orderService->orderAccept($requestPostParams));
                    break;
                case 'order_denied':
                    $orderService = SlLoader::cLoad('Order','OrderService');
                    $this->json(__($orderService->orderDenied($requestPostParams)));
                    break;
                case 'register':
