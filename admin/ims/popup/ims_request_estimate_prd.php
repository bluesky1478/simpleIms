<tr>
    ...
    <th>생산처 납기일</th>
    <td>
        <date-picker v-model="prepared.contents.produceDeliveryDt" value-type="format" format="YYYY-MM-DD" :lang="lang" :editable="false" placeholder="생산처 납기일" style="max-width: 120px!important;width:120px!important; font-weight: normal;"></date-picker>
    </td>
</tr>
<tr>
    <th >기획서</th>
    ...
    <th >견적 요청서</th>
    <td>
        <simple-file-only :file="fileList.filePreparedEstimateMs1" :id="'filePreparedEstimateMs1'" :project="project" ></simple-file-only>
    </td>
</tr>
<tr>
    <th >생산국가</th>
            ...
            <div>
                <table class="table table-rows table-default-center">
                    ...
                    <tr>
                        ...
                        <td>{% $.setNumberFormat(product.fabricCost) %}원</td>
                        <td>{% $.setNumberFormat(product.subFabricCost) %}원</td>
                        <td>
                        ...
                        <td>
                            <input type="number" class="form-control text-center" placeholder="생산MOQ" v-model="product.prdMoq">
                        </td>
                        <td>
                            <input type="number" class="form-control text-center" placeholder="단가MOQ" v-model="product.priceMoq">
                        </td>
                        <td>
                            <input type="number" class="form-control text-center" placeholder="MOQ미달 추가금" v-model="product.addPrice">
                        </td>
                    </tr>
                </table>
            </div>
