...
/**
 * 프로젝트 리스트 25년 10월 Version (디자인)
 */
class Ims25ListDesignController extends \Controller\Admin\Controller{
    ...
    public function index(){
        $this->callMenu('ims', 'list', 'design');
        $this->setData('current', 'design');
