    ...
    <tr  v-for="(each , index) in listData">
        ...
        <td class="ta-l pdl5 relative" :rowspan="each.projectRowspan" v-if="each.projectRowspan > 0">
            <div class="dp-flex dp-flex-gap5">
                <div class="hover-btn cursor-pointer" @click="window.open(`ims_view2.php?sno=${each.sno}`)">
                    <div class="dp-flex">
                        ...
                        <!--<span class="round-box sl-badge-small-blue font-11"  v-if="'y' === each.bizPlanYn" style="padding:2px">
                            사업계획
                        </span>-->
                    </div>
