...
/**
 * 프로젝트 상세 ( 최신 버전 24/12/16 )
 */
class ImsViewController extends \Controller\Admin\Controller{
    ...
    public function index()
    {
        ...
        $this->getView()->setPageName("ims/ims_view.php");
        ...
        $this->setData('prdSetupData', $this->setupProductListType()); //스타일 기본
     ...
     * @return \array[][]
     */
    public function setupProductListType(){
        return [
            'list' => [
                ['이미지',5],
                ['상품명',13],
