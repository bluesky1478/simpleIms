...
<script type="text/javascript">
    ...
    $(()=>{
        ...
        $('.js-save').click(function(){
            ...
            <?php if( 'customer' === $request['target'] ) {   ?> //fieldUpdateProduce
            let mode = 'fieldUpdate';
            <?php }else if( !empty($request['target']) ) {   ?>
            let mode = 'fieldUpdate<?=ucfirst($request['target'])?>';
            <?php }else{  ?>
            let mode = 'fieldUpdateProduce';
            <?php }  ?>
