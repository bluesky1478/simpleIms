 ...
 * @author  su
 */
class OEK25SF extends \Controller\Admin\Controller{
    ...
    public function index(){
        $list = $this->getList( '1000000465' , '1000000467', '1000000466');
        $div = "정직원";
        $refineList = [];
    ...
    public function makeExcel($refineList, $div){
        $goodsTitle1 = '춘추 카라티(25)';
        $goodsTitle2 = '춘추 조끼(25)';
        $goodsTitle3 = '춘추 점퍼(25)';
        $goodsTitle4 = '춘추 바지(25)';
    ...
    public function getList($teeCode1,$teeCode2,$pantsCode){
