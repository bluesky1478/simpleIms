    ...
    <div class="table-dashboard">
        <table id="data-table" style="display: none" class="table table-cols dn">
                ...
                <tr>
                    <th>
                        옵션
                        <div class="btn btn-sm btn-white" @click="addOption(items)">+추가</div>
                    </th>
                    <td colspan="3">
                        ...
                        <table class="table table-cols">
                            ...
                            <tr v-for="(item, index) in items.option" :key="index">
                                <td>
                                    <input type="text" class="form-control" v-model="item.optionName">
                                    <div class="btn btn-sm btn-white mgt5" style="float:right"  @click="removeListData(items.option, index)">- 옵션삭제</div>
                                    <div style="clear:both"></div>
                                </td>
                                <td>
                                    <input type="text" class="form-control" v-model="item.orderCnt">
                                </td>
                                <td>
                                    <input type="text" class="form-control" v-model="item.inputCnt">
                                </td>
                                <td>
                            ...
                            <tr v-if=" typeof items.option == 'undefined'  ||  0 >= items.option.length" >
