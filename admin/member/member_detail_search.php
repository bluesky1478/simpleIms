<div class="search-detail-box form-inline">
    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td>
                <label class="radio-inline">
                    <input type="radio" name="memberType" value="all" <?= gd_isset($checked['memberType']['all']); ?>/>
                    전체
                </label>
                <label class="radio-inline">
                    <input type="radio" name="memberType" value="1" <?= gd_isset($checked['memberType']['1']); ?>/>
                    정규직원
                </label>
                <label class="radio-inline">
                    <input type="radio" name="memberType" value="2" <?= gd_isset($checked['memberType']['2']); ?>/>
                    파트너사
                </label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <label class="radio-inline">
                    <input type="radio" name="connectedFl" value="" <?= gd_isset($checked['connectedFl']['']); ?>/>
                    전체
                </label>
                <label class="radio-inline">
                    <input type="radio" name="connectedFl" value="y" <?= gd_isset($checked['connectedFl']['y']); ?>/>
                    연결됨
                </label>
                <label class="radio-inline">
                    <input type="radio" name="connectedFl" value="n" <?= gd_isset($checked['connectedFl']['n']); ?>/>
                    미연결
                </label>
            </td>
        </tr>
