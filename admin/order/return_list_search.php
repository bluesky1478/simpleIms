    ...
    <table class="table table-cols">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>처리상태</th>
                <td>
                    <label class="radio-inline"><input type="radio" name="returnStatus" value="all" <?=gd_isset($checked['returnStatus']['all']); ?> />전체</label>
                    <label class="radio-inline"><input type="radio" name="returnStatus" value="1" <?=gd_isset($checked['returnStatus']['1']); ?> />접수</label>
                    <label class="radio-inline"><input type="radio" name="returnStatus" value="2" <?=gd_isset($checked['returnStatus']['2']); ?> />접수확인</label>
                    <label class="radio-inline"><input type="radio" name="returnStatus" value="3" <?=gd_isset($checked['returnStatus']['3']); ?> />회수완료</label>
                </td>
            </tr>
            <tr>
                <th>기간검색</th>
