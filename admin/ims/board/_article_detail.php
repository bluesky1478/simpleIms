            ...
            <td colspan="3">
                <table class="table table-rows table-fixed">
                    ...
                    <?php if ($bdView['cfg']['bdMemoFl'] == 'y' && $bdView['data']['memoList']) { ?>
                        <?php foreach ($bdView['data']['memoList'] as $val) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <form name="frmMemo<?= $val['sno'] ?>" action="../board/memo_ps.php" method="post" target="ifrmProcess">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <form name="frmMemoWrite" action="../board/memo_ps.php" method="post" target="ifrmProcess">
                                <input type="hidden" name="bdId" value="<?= $bdView['cfg']['bdId'] ?>">
                                <input type="hidden" name="bdSno" value="<?= $req['sno'] ?>">
