...
<script type="text/javascript">
    const listField = [
        ...
        // 예정 (첫번째 TR) ######################################################
        { title : '최종생산가', type : 'schedule', name : 'costConfirm', col : 3, class : 'bg-light-yellow' },
        { title : '발주', type : 'schedule', name : 'productionOrder', col : 3, class : 'bg-light-yellow' },
        { title : 'QC 리포트', type : 'schedule', name : 'qcReport', col : 3, class : 'bg-light-yellow' },
        { title : '인라인', type : 'schedule', name : 'qcReport', col : 3, class : 'bg-light-yellow' },
        { title : '납품보고서', type : 'schedule', name : 'projectComplete', col : 3, class : 'bg-light-yellow' },
        // 완료 (두번째 TR) ######################################################
        { title : '최종생산가', type : 'schedule', name : 'costConfirm', col : 3, subRow : true },
        { title : '발주', type : 'schedule', name : 'productionOrder', col : 3, subRow : true },
        { title : 'QC 리포트', type : 'schedule', name : 'qcReport', col : 3, subRow : true },
        { title : '인라인', type : 'schedule', name : 'qcReport', col : 3, subRow : true },
        { title : '납품보고서', type : 'schedule', name : 'projectComplete', col : 3, subRow : true },
    ];
    const getListField = ()=>{
