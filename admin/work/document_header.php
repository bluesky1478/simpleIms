...
<script src="<?=URI_HOME?><?=PATH_SKIN?>work/assets/js/sl_js_module.js?ver=2"></script>
<script src="<?=URI_HOME?><?=PATH_SKIN?>work/assets/js/work_custom.js?ver=2"></script>
<script src="<?=URI_HOME?><?=PATH_SKIN?>work/assets/js/work_service.js?ver=2"></script>
...
<script src="https://cdn.jsdelivr.net/npm/vue2-datepicker@3.10.4/locale/ko.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/vue2-datepicker@3.10.4/index.css" type="text/css">

<link rel="stylesheet" href="<?=URI_HOME?><?=PATH_SKIN?>/work/work-common.css" type="text/css">
