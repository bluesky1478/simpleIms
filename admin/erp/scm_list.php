<div class="page-header js-affix">
    ...
    <div class="btn-group">
        <a href="../erp/scm_regist.php" class="btn btn-red-line">고객사 등록</a>
    </div>
</div>
    ...
    <table class="table table-rows">
        ...
        ?>
                <tr class="text-center">
                    ...
                    <td>
                        <a href="../erp/scm_modify.php?scmno=<?= $row['scmNo']; ?>" class="btn btn-dark-gray btn-sm">추가 정보 수정</a>
                    </td>
                    <td>
                        <a href="../erp/scm_regist.php?scmno=<?= $row['scmNo']; ?>" class="btn btn-dark-gray btn-sm">수정</a>
                    </td>
                </tr>
                <?php
            }
