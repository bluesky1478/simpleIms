...
<form id="frmSearchBase" method="get" class="content-form js-search-form js-form-enter-submit">
    ...
    <?php include('order_policy_list_search.php'); ?>
</form>
    ...
    <table class="table table-rows">
        ...
        ?>
                <tr class="center">
                    ...
                    <!--구매 수량-->
                    <td class="center text-nowrap"><?=number_format($val['goodsCnt']); ?></td>
                    <!--무상 제공 수량-->
                    <td class="center text-nowrap"><?=number_format($val['freeDcCount']); ?></td>
                    <!--무상 제공 금액-->
                    <td class="center text-nowrap"><?=number_format($val['freeDcAmount']); ?></td>
                    <!--본사지불금액-->
                    <td class="center text-nowrap"><?=number_format($val['companyPayment']); ?></td>
                    <!--구매자지불금액-->
                    <td class="center text-nowrap"><?=number_format($val['buyerPayment']); ?></td>
                    <!--총금액-->
                    <td class="center text-nowrap"><?=number_format($val['totalPayment']); ?></td>
                    <!--주문상태-->
                    <td class="center text-nowrap"><?=$orderStatusMap[$val['orderStatus']]; ?></td>
                    <!--등록일자-->
                    <td class="center text-nowrap font-date">
