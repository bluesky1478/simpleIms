 ...
 * 문서 리스트
 */
class ImsApprovalListController extends \Controller\Admin\Controller{

    use ImsControllerTrait;

    public function index(){
        $request = \Request::request()->toArray();
        $this->callMenu('ims', 'board', 'approval');
        $this->setDefault();
        ...
        $this->getView()->setPageName("ims/ims_approval_list_bundle.php");
