                ...
                <tr>
                    ...
                    <td>
                        <div class="form-inline">
                            <input type="text" name="policyName" id="policyName" class="form-control"/>
                        </div>
                    </td>
                    <th>무상횟수</th>
                    <td>
                        <div class="form-inline">
                            <input type="text" name="freeBuyerCount" class="form-control js-number"  style="width:60%" /> 회
                        </div>
                    </td>
                    <th>
        ...
        <div class="js-field-select-wapper">
            <table class="table table-rows">
                ...
                <tr v-for="(item, index) in items" :key="index">
                    ...
                    <td class="center">
                        <input type="text" name="freeBuyerCount" :value="item.freeBuyerCount" :data-sno="item.sno" class="form-control center" @keyup="updateInputPolicy"  readonly />
                    </td>
                    <!--<td class="center">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
        //console.log($('input[name*="goodsNo"]:checked').length);
	    var appPolicyList = new Vue({
            ...
            , methods : {
                addPolicy : function(){
                    $("input[name='mode']").val('add_free_policy');
                ...
                , updateInputPolicy : function(e){
                    var updateData = {
                        ...
                        , updatePolicyType : 'freeSale' // freeSale, sale, survey
                    };
        ...
        var setPolicyItemList = function(){
            $.post('goods_ps.php', 'mode=get_free_policy_list', function (data) {
