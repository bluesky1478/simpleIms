...
namespace Controller\Admin\Ajax;
 ...
 */
class ClaimServiceController extends \Controller\Admin\Controller
{
     ...
     * @param $params
     */
    public function setChange($params){
        $claimData = SlCommonUtil::transactionMethod($this->claimBoardService, 'setChange', $params['sno']);
        $this->setJson(200, __('처리 완료'),$claimData);
    }
