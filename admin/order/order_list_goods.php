<div class="page-header js-affix">
    ...
    <div class="btn-group">
        <input type="button" value="송장 일괄 등록" class="btn btn-red-line" onclick="$('.excel-upload-goods-info').show('fade')"  />
        <input type="submit" value="회원 등록" class="btn btn-red-line" id="btnJoin"/>
    </div>
</div>

<div class="excel-upload-goods-info display-none">
    <form id="frmModifyGoodsInfo" name="frmModifyGoodsInfo" action="../scm/scm_custom_ps.php" method="post" enctype="multipart/form-data" target="ifrmProcess">
        <table class="table table-cols">
            ...
            <tr>
                <th>택배사 선택</th>
                <td>
                    <?= gd_select_box('invoiceExcelBatchCompany', 'invoiceExcelBatchCompany', $deliveryCom, null, '8', null); ?>
                </td>
            </tr>
            <!--<tr>
                <th>송장 정보 업로드(상품코드별)</th>
                <td>
                    <div class="form-inline">
                        <input type="hidden" name="mode" value="invoice_excel_upload"/>
            ...
            <tr>
                <th>송장 정보 업로드(주문번호별)</th>
                <td>
                    <div class="form-inline">
                        <input type="hidden" name="mode" value="invoice_excel_upload_order"/>
                        <input type="file" name="excel" value="" class="form-control width50p" />
                        <input type="submit"  class="btn btn-white btn-sm excel-submit" value="엑셀업로드 하기">
                    </div>
                    <div>
...
<form id="frmOrderStatus" action="./order_ps.php" method="post" enctype="multipart/form-data">
    <input type="hidden" name="mode" value="combine_status_change" id="frmMode"/>
