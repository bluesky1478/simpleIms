    ...
    <div class="col-xs-12" id="layoutOrderViewOrderInfoArea">
        ...
        <div v-if="typeof project.scheduleStatus != 'undefined' && !$.isEmpty(project.scheduleStatus)" >
            <div class="table-title gd-help-manual">
                    ...
                    <div class="dp-flex dp-flex-gap20 font-15 mgt10 mgb5">
                        ...
                        <div class="dp-flex dp-flex-center round-box bg-light-gray2 w-190px">
                            ...
                            <div class="">
                                <?php
                                $modifyKey='isModify';
                                $model='project.designManagerSno';
                                $modelValue='project.designManagerNm';
                                $defaultValue=['0','미정'];
                                $listData=$designManagerList;
                                $selectWidth=130;
                                ?>
                                <?php include 'basic_view/_select.php'?>
                            </div>
                ...
                <div class="flo-right ">
                    <div class="dp-flex" style="position:absolute;top:35px; right:20px">
            ...
            <div >
                <table class="table ims-schedule-table w100 table-default-center table-fixed  table-td-height35 table-th-height35 mgb10 table-pd-3">
                    ...
                    <tr>
                        ...
                        <th class="" colspan="3">제안</th>
                        <th class="" colspan="3">샘플</th>
                        <th class="" colspan="3">발주준비</th>
                        <th class="" rowspan="2">Q/B</th>
                        <th class="" rowspan="2">판매가</th>
                        <th class="" rowspan="2">생산가</th>
                    </tr>
                    <tr>
                        <th style="border-top: solid 1px #dddddd !important;">기획서</th>
                        <th style="border-top: solid 1px #dddddd !important;">제안서</th>
                        <th style="border-top: solid 1px #dddddd !important;">제안서발송</th>
                        <th style="border-top: solid 1px #dddddd !important;">샘플지시서</th>
                        <th style="border-top: solid 1px #dddddd !important;">샘플완료일</th>
                        <th style="border-top: solid 1px #dddddd !important;">샘플발송</th>
                    ...
                    <tr>
                        ...
                        <td class="bg-light-yellow">
                            <expected-template :modify="isModify" :data="project.schedule.plan" :title="'기획서'"></expected-template>
                        </td>
                        <td class="bg-light-yellow">
                            <expected-template :modify="isModify" :data="project.schedule.proposal" :title="'제안서'"></expected-template>
                        </td>
                        <td class="bg-light-yellow">
                            <expected-template :modify="isModify" :data="project.schedule.custInform" :title="'제안서 발송'"></expected-template>
                        </td>
                        <td class="bg-light-yellow">
                            <expected-template :modify="isModify" :data="project.schedule.sampleOrder" :title="'샘플 지시서'"></expected-template>
                        </td>
                        <td class="bg-light-yellow">
                            <expected-template :modify="isModify" :data="project.schedule.sampleOut" :title="'샘플 완료일'"></expected-template>
                        </td>
                        <td class="bg-light-yellow">
                            <expected-template :modify="isModify" :data="project.schedule.custSampleInform" :title="'샘플 발송'"></expected-template>
                        </td>
                        <td class="bg-light-yellow">
                    ...
                    <tr>
                        ...
                        <td>
                            <!--<div v-if="!isModify">
                                <complete-template :modify="isModify" :data="project.schedule.plan" :title="'기획서'"></complete-template>
                            </div>
                            <div v-if="isModify" class="text-muted">
                                직접수정불가
                            </div>-->
                            <complete-template :modify="isModify" :data="project.schedule.plan" :title="'기획서'"></complete-template>
                        </td>
                        <td class=" ">
                            <!--<div v-if="!isModify">
                                <complete-template :modify="isModify" :data="project.schedule.proposal" :title="'제안서'"></complete-template>
                            </div>
                            <div v-if="isModify" class="text-muted">
                                직접수정불가
                            </div>-->
                        ...
                        <td class="">
                            <complete-template :modify="isModify" :data="project.schedule.custInform" :title="'제안서 발송'"></complete-template>
                        </td>
                        <!--샘플단계 완료일-->
                        <td class="">
                            <complete-template :modify="isModify" :data="project.schedule.sampleOrder" :title="'샘플 지시서'"></complete-template>
                        </td>
                        <td class="">
                            <complete-template :modify="isModify" :data="project.schedule.sampleOut" :title="'샘플 완료일'"></complete-template>
                        </td>
                        <td class="">
                            <complete-template :modify="isModify" :data="project.schedule.custSampleInform" :title="'샘플 발송'"></complete-template>
                        </td>
                        <!--발주단계 완료일-->
                        <td class="">
                        ...
                        <!--
                        <td rowspan="2" class="border-bottom-light-gray-imp">
                        ...
                        <td rowspan="2" class="border-bottom-light-gray-imp">
                            <div >
                                <div class="btn btn-sm btn-red btn-red-line2">결재 요청</div>
                            </div>
                            <div class="btn btn-white btn-sm" @click="showSchedule()">
                                결재정보
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <!--파일 없음 : PASS (기획) -->
                            <div class="cursor-pointer hover-btn sl-green" @click="showSchedule()"
                                 v-if="!$.isEmpty(fileList.filePlan) && 0 >= fileList.filePlan.files.length && 'p' === project.planConfirm">
                                기획서 PASS
                            </div>
                        ...
                        <td>
                            <!--파일 없음 : PASS ( 제안 ) -->
                            <div class="cursor-pointer hover-btn sl-green" @click="showSchedule()"
                                 v-if="!$.isEmpty(fileList.fileProposal) && 0 >= fileList.fileProposal.files.length && 'p' === project.proposalConfirm">
                                제안서 PASS
                            </div>
        ...
        <div class="js-layout-order-view-receiver-info">
            ...
            <div >
                ...
                <div v-show="showStyle && 'basic' == styleTabMode" class="new-style2">
                    <?php include 'style/type_default.php'?>
                </div>
                <div v-show="showStyle && 'sample' == styleTabMode" class="">
                    <?php include 'style/type_sample.php'?>
                </div>
        ...
        <div >
            <table class="table table-cols ims-table-style1 table-td-height30 table-th-height30">
                ...
                <tr>
                    <th>세탁 방법</th>
                    <td colspan="3">
                        <?php $model='project.addedInfo.etc19'; $placeholder='세탁 방법' ?>
                        <?php include 'basic_view/_text.php'?>
                    </td>
                </tr>
                </tbody>
        ...
        <div >
            <table class="table table-cols ims-table-style1 table-td-height30 table-th-height30">
                ...
                <tr>
                    ...
                    <td colspan="99">
                        <?php $model='project.addedInfo.etc20'; $placeholder='단가 인상 가능 여부' ?>
                        <?php include 'basic_view/_text.php'?>
                    </td>
                </tr>
                </tbody>
