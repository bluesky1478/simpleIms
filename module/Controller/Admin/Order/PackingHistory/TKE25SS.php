...
class DownloadTkeReleaseController extends \Controller\Admin\Controller{
    ...
    public function index(){
        ...
        if( !empty($getValue['mode']) && 'partner' === $getValue['mode'] ){
            $list = $this->getList( '1000000561' , '1000000562' ); //25하계 파트너
            $div = "파트너";
        }else{
            $list = $this->getList( '1000000561' , '1000000562' );//25하계
            $div = "정직원";
        }
    ...
    public function makeExcel($refineList, $div){
        ...
        $goodsTitle1 = '25하계 파트너 카라티';
        $goodsTitle2 = '25하계 파트너 바지';
        ...
        $htmlList[] = ExcelCsvUtil::wrapTh('상의+바지 합계','title','background-color:#fff2cc; font-weight:bold','rowspan=2');
    ...
    public function getList($teeCode, $pantsCode){
        ...
        $sql = "
            ...
            join es_memberGroup f
              on e.groupSno = f.sno
            where 1=1
            -- and ( a.orderStatus = 'p1' or a.orderStatus = 'p2' )
