<form name="frmOrder" method="post" class="frm-order" id="documentApp" @submit.stop.prevent="onSubmit(items)"  >
    ...
    <div class="row">
        ...
        <div v-for="(item, index) in items.docData.sampleData" :key="index" v-show="index == items.showSelectedStyle" >
            ...
            <div class="col-xs-12">
                <div class="table-title ">
                    <div class="flo-left" >도식화 이미지 미리보기</div>
                    <div class="flo-right " ></div>
                </div>
                <table class="table table-cols">
                    <tr>
            ...
            <div class="col-xs-12">
                ...
                <div class="table-title ">
                    ...
                    <div class="flo-right " >
                        <small class="text-danger">옵션명에 컴마( <span class="font-15">,</span> ) 사용시 오류가 발생할 수 있습니다.</small>
                    </div>
                </div>
                <div  style="clear:both">
                    <table class="table table-cols center-header center-contents sample-spec-table" >
                        ...
                        <tr v-for="(typeItem, typeIndex) in item.typeList">
                            <td class="text-right">
                                <input type="text" class="form-control full-left" v-model="typeItem.typeName" style="width:150px" placeholder="구분">
                                <div class="btn btn-sm btn-white full-left" @click="addType(items,index)" >+추가</div>
                                <div class="btn btn-sm btn-white full-left" @click="removeListData(item.typeList, typeIndex)" v-if="item.typeList.length > 1" >-삭제</div>
                    ...
                    <table class="table table-cols center-header center-contents sample-spec-table">
                        ...
                        <tr>
                            ...
                            <th v-for="(optionItem, optionIndex) in item.optionList">
                                ...
                                <br><small class="text-muted btn btn-white btn-sm" @click="deleteSpec(item.checkList, 'checkSpec', optionIndex)">초기화</small>
                            </th>
                            <th>단위</th>
