<script type="text/javascript">
    ...
    $(()=>{
        ...
        const tabMode = <?=empty($requestParam['tabMode']) || 'undefined' == $requestParam['tabMode'] ?'-1':$requestParam['tabMode']?>;
