    ...
    <div class="">
        ...
        <div class="flo-right mgb5">
            <div class="" style="display: flex; ">
                ...
                <span v-show="isModify" @click="addElement(listData, {'sno':'', 'infoType':'', 'infoName':''}, 'after')" class="btn btn-red-line" style="margin-left:10px;">추가</span>
            ...
            <tr v-for="(val , key) in listData">
                ...
                <td class="ta-l">
                    <span v-show="isModify">
                        <input type="text" v-model="val.infoName" class="form-control" />
                    </span>
                    <span v-show="!isModify">{% val.infoName %}</span>
                </td>
                <td>
