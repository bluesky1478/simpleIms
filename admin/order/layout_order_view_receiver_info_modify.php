        ...
        <td>
            <?php if (empty($data['isDefaultMall']) === true) { ?>
                ...
                <div class="form-inline">
                    ...
                    <input type="hidden" name="info[receiverZipcode]" value="<?= gd_isset($data['receiverZipcode']); ?>" id="receiverZipcode" />
                </div>
                <div class="mgt5">
            ...
            <?php } else { ?>
                <!-- 기준몰 -->
                <div class="form-inline">
                    <input type="text" name="info[receiverZonecode]" value="<?= gd_isset($data['receiverZonecode']); ?>" size="5" class="form-control" id="receiverZonecode" />
            ...
            <div class="mgt5">
                <input type="text" name="info[receiverAddress]" value="<?= gd_isset($data['receiverAddress']); ?>" class="form-control"  id="receiverAddress" />
            </div>
            <div class="mgt5">
                <input type="text" name="info[receiverAddressSub]" value="<?= gd_isset($data['receiverAddressSub']); ?>" class="form-control"  id="receiverAddressSub" />
            </div>

            <hr>

            TKE 주소 목록
            <select class="js-example-basic-single" id="select-delivery-list" style="width:100%">
                <option value="-1">== 선택 ==</option>
                <?php foreach ( $tkeDeliveryList as $listKey => $listValue ) { ?>
                <option value="<?=$listValue['receiverZonecode'].'▶'.$listValue['receiverAddress'].'▶'.$listValue['receiverAddressSub']?>"><?=$listValue['subject']?></option>
                <?php } ?>
            </select>
