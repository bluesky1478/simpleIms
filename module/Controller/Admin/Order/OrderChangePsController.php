    ...
    public function index()
    {
        ...
        switch ($postValue['mode']) {
            ...
            case 'refresh_order_status':
                ...
                $orderService->latestSyncOrderStatus($postValue['orderNo']);
                break;
            case 'cancel': // 상품 취소
                try {
                    // 취소 메세지
            ...
            case 'set_refine_han_tax' :
                ...
                $manualService->setTax($orderNo, 44800, '1000000377');
                $manualService->setTax($orderNo, 25000, '1000000376');
                $manualService->setTax($orderNo, 15200, '1000000378');
                $manualService->setTax($orderNo, 19000, '1000000379');
